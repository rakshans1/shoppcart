...
<li><a href="checkout"><i class="shopping-cart fa fa-shopping-cart"></i> Cart <span class="badge"><?php 
echo isset($_SESSION['item_quantity']) ? $_SESSION['item_quantity'] : $_SESSION['item_quantity'] = "0";?></span></a></li>
<?php
