...
if (strpos($curl_result, "VERIFIED") !== false) {
    ...
    mail("Superswami1329@gmail.com", "IPN interaction not verified", "$req", "From: Superswami1329@gmail.com" );
    exit();
}
...
if ($receiver_email != "Superswami1329.com") {
    $message = "Investigate why and how receiver email is wrong. Email = " . $_POST['receiver_email'] . "\n\n\n$req";
    mail("Superswami1329@gmail.com", "Receiver Email is incorrect", $message, "From: Superswami1329@gmail.com" );
    exit(); // exit script
}
// Check number 2 ------------------------------------------------------------------------------------------------------------
...
if ($numRows > 0) {
    ...
    mail("Superswami1329@gmail.com", "Duplicate txn_id in the IPN system", $message, "From: Superswami1329" );
    exit(); // exit script
} 
// Check number 4 ------------------------------------------------------------------------------------------------------------
...
if ($fullAmount != $grossAmount) {
        ...
        mail("Superswami1329@gmail.com", "Price Jack or Bad Programming", $message, "From: Superswami1329@gmail.com" );
        exit(); // exit script
} 
...
mail("Superswami1329@gmail.com", "NORMAL IPN RESULT YAY MONEY!", $req, "From: Superswami1329@gmail.com");
?>